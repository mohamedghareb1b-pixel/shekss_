    ...
    <div class="dash-page">
      ...
      <aside class="dash-sidebar adm-sidebar">
        ...
        <nav class="dash-nav">
          ...
          ${_adminNavItem('all-deals',        '🏷️', 'إدارة كل العروض')}
          ${_adminNavItem('admin-add-deal',   '➕', 'إضافة عرض')}
...
function switchAdminSection(section) {
  ...
  const titles = {
    ...
    'all-deals':         { title: 'إدارة كل العروض',    sub: 'تعديل أو حذف أي عرض مباشرة' },
  ...
  if (section === 'all-deals')         renderAdminAllDeals();
